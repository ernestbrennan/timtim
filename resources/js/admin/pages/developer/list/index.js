...
import {getList} from '$admin/api/developer'
...
export default function ReactTables() {
  ...
  const editRoute = getRouteByKey('developer_edit');
    ...
    <GridContainer>
      <GridItem xs={12}>
        <GridContainer justify={'flex-end'}>
          <GridItem>
            <Button color="primary" justIcon to={"/app/developer/create"} round>
              <AddIcon/>
            </Button>
          </GridItem>
        </GridContainer>
      ...
      <GridItem xs={12}>
        <Card>
          <CardHeader color="primary" icon>
            ...
            <h4 className={classes.cardIconTitle}>Developer Table</h4>
          </CardHeader>
          <CardBody>
            <ReactTable
              columns={[
